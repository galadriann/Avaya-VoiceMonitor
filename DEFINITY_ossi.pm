...
use constant PBX_CONFIG_FILE => '/opt/lampp/htdocs/pbx/pbx_connection_auth.xml';
...
#=============================================================
    ...
    print "getting connection parameters for $nodename\n";# if $DEBUG;
        ...
        my $config = XMLin( PBX_CONFIG_FILE );
...
#~ print "$self, $host, $port, $username, $password, $connection_type, $atdt\n";
    my $success = 0;
